...
none only for the rc3, but you can use these one with the alternative data-url [https://data.c3voc.de/rC3/everything.schedule.xml](https://data.c3voc.de/rC3/everything.schedule.xml)
